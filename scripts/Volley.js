 ...
 * Inspired by bird chirps, e.g., "chirp chirp chirp" pause "chirp chirp" pause "chirp chirp chirp chirp" pause etc.
 * Based on (and fairly identical to) the Chirp object from the Ornithology project
 * Maybe a first study towards a more fully (quasi-)fractal system
 */


// creating a Volley object with an object constructor
function Volley(intermittentSound, minPause, maxPause, minReps, maxReps, startWithPause) {
